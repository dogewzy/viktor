...
def get_llm_summary(window_minutes: int = Query(default=60, ge=1, le=24 * 60)) -> dict:
    return llm_summary(window_minutes=window_minutes)
...
def get_llm_calls(
    ...
    return list_llm_calls(limit=limit, offset=offset, provider=provider, feature=feature)
