...
def create_or_update_issue_by_marker(
    *,
    project_url: str,
    marker: str,
    title: str,
    ...
    """Create or update an open issue identified by a stable HTML marker in its body."""
    search_labels = labels or []
    candidates = list_issues(project_url=project_url, state="opened", labels=search_labels[:1] or None)
